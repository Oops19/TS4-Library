...
class SimCacheCheatCommands:
    ...
    @staticmethod
    @CommonConsoleCommand(ModInfo.get_identity(), 'o19.ts4l.sc.init', 'Refresh the cache.', )
    ...
    @staticmethod
    @CommonConsoleCommand(ModInfo.get_identity(), 'o19.ts4l.sc.dump', 'Dump all data to the log file.', )
    def o19_sc_refresh(output: CommonConsoleCommandOutput):
        try:
    ...
    @staticmethod
    @CommonConsoleCommand(ModInfo.get_identity(), 'o19.ts4l.sc.search', 'Search sims.',
                          command_arguments=(
    ...
    def o19_sc_search_sim(output: CommonConsoleCommandOutput, sim_name: str):
        try:
            ...
            match, equals, starts, ends, contains = sc.get_sim_ids_by_sim_name(sim_name)
