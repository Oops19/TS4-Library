...
class ResourceTypes:
    ...
    SLIDERS = [CustomResourceType.SCULPT.value, CustomResourceType.SIM_MODIFIER.value, ]
    ...
    PNG_IMAGES = [
        ...
        CustomResourceType.IMAGE_CAS_PART_THUMBNAIL.value,
        CustomResourceType.IMAGE_CAS_BUILD_THUMBNAIL.value,
    ]
    JPG_IMAGES = [
        # image format might be PNG or DST in UGC
        CustomResourceType.IMAGE_JPG_1.value,
        CustomResourceType.IMAGE_JPG_2.value,
        CustomResourceType.IMAGE_JPG_3.value,
        CustomResourceType.IMAGE_JPG_4.value,
        CustomResourceType.IMAGE_JPG_5.value,
        CustomResourceType.IMAGE_JPG_6.value,
        CustomResourceType.IMAGE_JPG_7.value,
    ]
