...
class CustomGamePack(CustomEnum):
    try:
        ...
        BASE_GAME: 'CustomGamePack' = _common_types.BASE_GAME
        FP01_HOLIDAY_CELEBRATIONS: 'CustomGamePack' = _common_types.FP01

        EP01_GET_TO_WORK: 'CustomGamePack' = _common_types.EP01
        EP02_GET_TOGETHER: 'CustomGamePack' = _common_types.EP02
        EP03_CITY_LIVING: 'CustomGamePack' = _common_types.EP03
        EP04_CATS_AND_DOGS: 'CustomGamePack' = _common_types.EP04
        EP05_SEASONS: 'CustomGamePack' = _common_types.EP05
        EP06_GET_FAMOUS: 'CustomGamePack' = _common_types.EP06
        EP07_ISLAND_LIVING: 'CustomGamePack' = _common_types.EP07
        EP08_DISCOVER_UNIVERSITY: 'CustomGamePack' = _common_types.EP08
        EP09_ECO_LIFESTYLE: 'CustomGamePack' = _common_types.EP09
        EP10_SNOWY_ESCAPE: 'CustomGamePack' = _common_types.EP10
        EP11_COTTAGE_LIVING: 'CustomGamePack' = _common_types.EP11
        EP12_HIGH_SCHOOL_YEARS: 'CustomGamePack' = _common_types.EP12  # 2022-07-28
        EP13_GROWING_TOGETHER: 'CustomGamePack' = _common_types.EP13
        EP14_HORSE_RANCH: 'CustomGamePack' = _common_types.EP14
        EP15_FOR_RENT: 'CustomGamePack' = _common_types.EP15
        EP16_LOVESTRUCK: 'CustomGamePack' = _common_types.EP16  # 2024-07-25
        EP17_LIFE_AND_DEATH: 'CustomGamePack' = _common_types.EP17  # 2024-10-31
        ...
        GP03_DINE_OUT: 'CustomGamePack' = _common_types.GP03
        GP04_VAMPIRES: 'CustomGamePack' = _common_types.GP04
        GP05_PARENTHOOD: 'CustomGamePack' = _common_types.GP05
        GP06_JUNGLE_ADVENTURES: 'CustomGamePack' = _common_types.GP06
        GP07_STRANGERVILLE: 'CustomGamePack' = _common_types.GP07
        GP08_REALM_OF_MAGIC: 'CustomGamePack' = _common_types.GP08
        GP09_STAR_WARS_JOURNEY_TO_BATUU: 'CustomGamePack' = _common_types.GP09
        GP10_DREAM_HOME_DECORATOR: 'CustomGamePack' = _common_types.GP10
        GP11_MY_WEDDING_STORIES: 'CustomGamePack' = _common_types.GP11
        GP12_WEREWOLVES: 'CustomGamePack' = _common_types.GP12

        SP01_LUXURY_PARTY: 'CustomGamePack' = _common_types.SP01
        SP02_PERFECT_PATIO: 'CustomGamePack' = _common_types.SP02
        SP03_COOL_KITCHEN: 'CustomGamePack' = _common_types.SP03
        SP04_SPOOKY: 'CustomGamePack' = _common_types.SP04
        SP05_MOVIE_HANGOUT: 'CustomGamePack' = _common_types.SP05
        SP06_ROMANTIC_GARDEN: 'CustomGamePack' = _common_types.SP06
        SP07_KIDS_ROOM: 'CustomGamePack' = _common_types.SP07
        SP08_BACKYARD: 'CustomGamePack' = _common_types.SP08
        SP09_VINTAGE_GLAMOUR: 'CustomGamePack' = _common_types.SP09
        SP10_BOWLING_NIGHT: 'CustomGamePack' = _common_types.SP10
        SP11_FITNESS: 'CustomGamePack' = _common_types.SP11
        SP12_TODDLER: 'CustomGamePack' = _common_types.SP12
        SP13_LAUNDRY_DAY: 'CustomGamePack' = _common_types.SP13
        SP14_MY_FIRST_PET: 'CustomGamePack' = _common_types.SP14
        SP15_MOSCHINO: 'CustomGamePack' = _common_types.SP15
        SP16_TINY_LIVING: 'CustomGamePack' = _common_types.SP16
        SP17_NIFTY_KNITTING: 'CustomGamePack' = _common_types.SP17
        SP18_PARANORMAL: 'CustomGamePack' = _common_types.SP18  # 202-01-26
        SP46_HOME_CHEF_HUSTLE: 'CustomGamePack' = _common_types.SP46  # 2023-09-28 ---
        SP49_CRYSTAL_CREATIONS: 'CustomGamePack' = _common_types.SP46  # 2024-02-29
        ...
        SP81_PRAIRIE_DREAMS: 'CustomGamePack' = _common_types.SP81  # 2025-12-11
        ...
        # Other Kits
        SP22_BUST_THE_DUST: 'CustomGamePack' = _common_types.SP22  # 2021-02-03 ***
        SP59_SECRET_SANCTUARY: 'CustomGamePack' = _common_types.SP59  # 2025-01-16
        SP60_CASANOVA_CAVE: 'CustomGamePack' = _common_types.SP60  # 2025-01-16
