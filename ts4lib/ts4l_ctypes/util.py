...
if os.name == "nt":
    ...
    from ts4lib.ts4l_ctypes.macholib.dyld import dyld_find as _dyld_find
    def find_library(name):
    ...
    from ts4lib.ts4l_ctypes._aix import find_library
...
def test():
    from ts4lib.ts4l_ctypes import cdll
    if os.name == "nt":
        print(cdll.msvcrt)
